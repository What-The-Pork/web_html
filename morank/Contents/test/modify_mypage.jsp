		...
		<div class="contents">
			<div class="content-items">
				<div class="content-item">
					...
					<!-- 프로필 수정 부분 -->
					<form action="modifyProfile.jsp" method="post" enctype="multipart/form-data">
						...
						<div class="content-text">
							<div class="content-item-nixname">
								<span>닉네임: <input type="text" class="nix_input" name ="nixname" value="" placeholder="<%=user.getNixname()%>"/> </span>
							</div>
						</div>
						<div class="text_btns">
							<!-- 수정 클릭 시 input 닉네임 변경하는 입력창(+중복확인) -->
							<button type="submit" class="edit_btn" name="button" onclick="location.href = 'modifyProfile.jsp'">수정</button>
