...
<script id = "thislink" >http://localhost:8080/MorangWebPage/Search_info_test.jsp</script>
<meta charset="utf-8">
<title>모랭검색테스트</title>
			...
			<section>
				...
				<div class="parent_container">
					...
					<div class="center_container">
						...
						%> 
						<form action ="insert.jsp" id="formcss" name="form1" method = "post" onsubmit="formCheck()">
					...
					<div class="sub_container">
						...
						<div class="ranking_box">
							...
							<div name = "moveinfonum"><%=notice.getINFO_ID() %></div>
							<input type="submit" id="movetoinfo" value="이동" style="float:right;" />
							</form>
						</div>
						<%
						}
			...
			<footer>
				<div class="footer" id="foot">
	          		<div class="company" id="foot">
	            		<a style=""><img src="logo/WTP.jpg" width="50px;"> <h2>What the Pork</h2></a>
	          		</div>
